        ...
        if ($model->load(Yii::$app->request->post()))
        {
            if($model->validate())
            {
                ...
                if ($table->insert())
                {
                    ...
                    $body .= "<a href='http://proyectoBase/index.php?r=site/confirm&id=".$id."&authKey=".$authKey."'>Confirmar</a>";
        ...
        if ($model->load(Yii::$app->request->post()))
        {
            if ($model->validate())
            {
                ...
                if ($table->count() == 1)
                {
                    ...
                    $body .= "<p><a href='http://proyectoBase/index.php?r=site/resetpass'>Recuperar password</a></p>";
